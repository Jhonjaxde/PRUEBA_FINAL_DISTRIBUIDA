...
public class ConsulRegistration {
    ...
    @ConfigProperty(name = "service.name", defaultValue = "web-service")
    String serviceName;
        ...
        String registerJson = String.format("""
            {
                ...
                "Address": "%s",
                "Port": %d,
                "Tags": ["quarkus", "web", "traefik.enable=true", "traefik.http.routers.web-service.rule=PathPrefix(`/`)"],
                "Check": {
